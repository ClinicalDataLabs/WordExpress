...
Q.) I ran foreman start and unable to access  localhost:5500 for the mysql database.

  + A.) Update the host property in WordExpress/settings/dev.json file with the ip docker-machine created. 
